...
function HomePage({
  ...
  const slider = useSlider(heroSlides);
  ...
  return (
    <>
      ...
      <section className="page-section" id="services">
        <SectionHeader title={t('sectionServices')}>{t('sectionServices')}</SectionHeader>
      ...
      <section className="page-section" id="astrology">
        <SectionHeader title={t('sectionAstrology')} />
        <div className="card-grid single-row">
